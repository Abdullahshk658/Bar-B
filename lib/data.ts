...
export const products: Product[] = [
  {
    ...
    stock: 3,
    is_3d_enabled: true,
    model_url: "https://huggingface.co/datasets/dylanebert/3dgs/resolve/main/bonsai/bonsai-7k-mini.splat",
    silhouette: "A-Line",
    fabric: "Lace",
    heroImage:
  ...
  },
  {
    ...
    stock: 2,
    is_3d_enabled: true,
    model_url: "https://huggingface.co/datasets/dylanebert/3dgs/resolve/main/bicycle/bicycle-7k-mini.splat",
    silhouette: "Mermaid",
    fabric: "Satin",
    heroImage:
